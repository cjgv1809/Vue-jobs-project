...
const showFullEmail = computed(() => {
  if (state.job.company?.contactEmail) {
    return state.job.company.contactEmail.length > MAX_EMAIL_LENGTH
      ? state.job.company.contactEmail.slice(0, MAX_EMAIL_LENGTH) + '...'
